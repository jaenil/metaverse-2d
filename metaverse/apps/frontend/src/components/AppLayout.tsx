...
export function AppLayout() {
  ...
  return (
    <div className="font-body-md text-on-background selection:bg-primary/30 selection:text-primary-fixed min-h-screen flex flex-col bg-background relative overflow-hidden" style={{ backgroundColor: '#0b1326' }}>
      ...
      <div className="flex flex-1 pt-20 md:pt-24 relative z-10 w-full max-w-full">
        {/* Sidebar */}
        <aside className="hidden lg:flex flex-col py-12 gap-y-8 bg-surface-container-low/60 backdrop-blur-xl border-r border-outline-variant/20 shadow-2xl fixed left-0 h-[calc(100vh-5rem)] md:h-[calc(100vh-6rem)] w-[320px] z-40 top-20 md:top-24 overflow-y-auto custom-scrollbar">
          <div className="px-10 space-y-2 shrink-0">
          ...
          <div className="px-10 pt-10 mt-auto shrink-0 pb-12">
        ...
        {/* Main Content Area */}
        <main className="flex-1 w-full lg:ml-[320px] pb-14 min-h-screen overflow-x-hidden">
          <Outlet />
        </main>
      </div>

      {/* Footer */}
      <footer className="bg-surface-container-lowest/90 border-t border-outline-variant/10 fixed bottom-0 w-full z-50 flex justify-between items-center px-8 md:px-16 py-4 h-14">
